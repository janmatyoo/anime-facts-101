            ...
            <div className="text-lg text-gray-700 leading-relaxed space-y-8">
              ...
              <section>
                ...
                <p>
                  ...
                  entertainment purposes only. We do not guarantee accuracy, completeness, or timeliness of the content.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  We embed YouTube videos and display ads from third-party services such as Google AdSense. These
                  services may collect data in accordance with their own privacy policies. We do not control or take
                  responsibility for external content or tracking technologies used by these providers.
                </p>
              </section>

              <section>
                <h2 className="text-xl font-semibold text-[#133162] mb-2">3. Intellectual Property</h2>
                <p>
                  All original content, including descriptions and formatting, is the property of Anime Facts 101. Anime
                  imagery, video, and names may be trademarks of their respective owners and are used under fair use for
                  commentary, education, and fan-based purposes.
                </p>
              </section>

              <section>
                <h2 className="text-xl font-semibold text-[#133162] mb-2">4. Limitations of Liability</h2>
                <p>
                  Anime Facts 101 is not liable for any loss or damage arising from the use of this site, including
                  inaccuracies, broken links, or third-party content.
                </p>
              </section>

              <section>
                <h2 className="text-xl font-semibold text-[#133162] mb-2">5. Changes to the Terms</h2>
                <p>
              ...
              <section>
                <h2 className="text-xl font-semibold text-[#133162] mb-2">6. Contact</h2>
                <p>
