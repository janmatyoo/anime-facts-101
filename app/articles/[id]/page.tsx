...
import Head from 'next/head' // ✅ for dynamic Open Graph metadata
  ...
  return (
    <>
      ...
      <Head>
        ...
        <meta name="description" content={article.details?.[0]?.details.slice(0, 160)} />
        <meta property="og:title" content={`${article.title} | Anime Facts 101`} />
        <meta property="og:description" content={article.details?.[0]?.details.slice(0, 160)} />
        <meta property="og:image" content={article.card_thumbnail} />
        <meta property="og:url" content={`https://animefacts101.com/articles/${article.id}`} />
        <meta property="og:type" content="article" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={`${article.title} | Anime Facts 101`} />
        <meta name="twitter:description" content={article.details?.[0]?.details.slice(0, 160)} />
        <meta name="twitter:image" content={article.card_thumbnail} />
        <link rel="canonical" href={`https://animefacts101.com/articles/${article.id}`} />
      </Head>
